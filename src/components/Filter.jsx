      ...
      <div
        className={`${
          roleFilter === "" && levelFilter === "" && languageFilter.length === 0
            ? "hidden"
            : ""
        } w-[24.5rem] xl:w-[calc(80%+8px)] 2xl:w-[calc(65%+8px)] absolute top-0 -translate-y-1/2 flex items-center bg-white rounded-md text-sm drop-shadow-xl`}
      >
        <div className="px-4 md:px-8 pt-1 pb-3 h-full w-full">
        ...
        <button
          ...
          className="text-dark-grayish-cyan font-bold px-4 md:px-8 hover:text-desaturated-dark-cyan hover:underline"
        >
          Clear
        </button>
      </div>
